...
{
    [Serializable]
    public class EditableRootListParent1 : BusinessBase<EditableRootListParent1>
    {
        ...
        private static readonly PropertyInfo<EditableChildList> ChildListProperty = RegisterProperty<EditableChildList>(p => p.ChildList, "Child list", RelationshipTypes.Child);
        ...
        public static EditableRootListParent1 NewEditableRootParent()
        {
            return DataPortal.Create<EditableRootListParent1>();
        }

        public static EditableRootListParent1 GetEditableRootParent(int id)
        {
            return DataPortal.Fetch<EditableRootListParent1>(id);
        }

        public static void DeleteEditableRootParent(int id)
        {
            DataPortal.Delete<EditableRootListParent1>(id);
        }

        private EditableRootListParent1()
