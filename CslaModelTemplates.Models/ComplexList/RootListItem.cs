...
namespace CslaModelTemplates.Models.ComplexList
{
    ...
    public class RootListItem : ReadOnlyModel<RootListItem>
    {
        ...
        public static readonly PropertyInfo<RootItemListItems> ItemsProperty = RegisterProperty<RootItemListItems>(c => c.Items);
        public RootItemListItems Items
        {
            ...
            )
        {
            ...
            Items = RootItemListItems.Get(dao.Items);
        }
