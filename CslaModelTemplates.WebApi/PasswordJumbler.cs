...
namespace CslaModelTemplates.WebApi.Security
{
    /// <summary>
    /// Implements the standard Identity password hashing.
    /// </summary>
    /// <typeparam name="TUser">The type used to represent a user.</typeparam>
    public class PasswordJumbler<TUser> : IPasswordHasher<TUser> where TUser : class
    {
        /* =======================
            ...
            )
        {
            ...
            switch (_compatibilityMode)
            {
                ...
                case PasswordHasherCompatibilityMode.IdentityV3:
                    ...
                    if (_iterCount < 1)
                    {
                        throw new InvalidOperationException(CommonText.PasswordJumbler_InvalidIterationCount);
                    }
                    break;

                default:
                    throw new InvalidOperationException(CommonText.PasswordJumbler_InvalidCompatibilityMode);
            }
        ...
        private static byte[] HashPasswordV2(
            string password,
        ...
        private static bool VerifyHashedPasswordV2(
            byte[] hashedPassword, 
            string password
            )
        {
